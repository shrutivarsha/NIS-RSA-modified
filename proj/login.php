...
$user2 = $_POST['user2'];
$src = "/proj/ww.php?email=".$username."&user2=".$user2;
...
<form action="login.php" method="post" id="myForm">
		...
		<div class="form-group">
			<div class="input-group">
				<span class="input-group-addon"><i class="fa fa-lock"></i></span>
				<input type="text" class="form-control" name="user2" id="password" placeholder="Username you want to contact" required="required">
			</div>
        </div>
